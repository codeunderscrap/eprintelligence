...
<head>
    ...
    <style>
        ...
        .sourcing-badge { font-size: 0.85rem; padding: 0.4rem 0.8rem; background-color: rgba(6,144,173,0.1); color: var(--primary-color); border: 1px solid var(--primary-color); }
        .console-header { background: linear-gradient(135deg, #001b2e 0%, #0690ad 100%); color: white; padding: 2rem; border-radius: 12px; margin-bottom: 24px; position: relative; overflow: hidden; }
    ...
    <div class="wrapper">
        ...
        <div class="main-content">
            ...
            <div class="console-header shadow-sm">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <span class="badge bg-success"><i class="bi bi-robot me-1"></i> AI Sourcing Agent Console</span>
                ...
                <div class="mt-3">
                    <span class="badge bg-warning text-dark px-3 py-2 fs-6 border border-warning shadow-sm"><i class="bi bi-tag-fill me-1"></i> EPR Target Classification: <?= htmlspecialchars($aiData['classification'] ?? 'Pending') ?></span>
                </div>
            </div>
